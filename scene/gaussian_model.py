...
class GaussianModel:
    ...
    def create_from_verts(self, points):
        ...
        self._scaling = self._scaling_base
        self._rotation_base = nn.Parameter(rots.requires_grad_(False))

        # self._rotation_base = self._rotation_base.requires_grad_(False)
        # print("Rotation base requires_grad:", self._rotation_base.requires_grad, "设置为不可训练")
    ...
    def update_xyz_rot_scale(self, points, rot_delta, scale_coeff):
        ...
        # print("self._rotation_base:", self._rotation_base.shape)
        # print("rot_delta:", rot_delta.shape)
        # import pdb; pdb.set_trace()
        self._rotation = quatProduct_batch(self._rotation_base, rot_delta)
        # print("Rotation requires_grad:", self._rotation_base.requires_grad)
        # print("Rotation base:", self._rotation_base)
